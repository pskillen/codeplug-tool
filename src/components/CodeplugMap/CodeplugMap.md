...
- **Maidenhead grid:** optional overlay (Off / 4-char / 6-char) from Settings; [`MaidenheadGridLayer`](MaidenheadGridLayer.tsx) draws viewport-scoped lines and cell labels below markers. See [maidenhead-grid doc](../../../docs/features/map/maidenhead-grid.md).
