...
| Export name shortening | Shipped | [#130](https://github.com/pskillen/codeplug-tool/issues/130) — [name-shortening.md](name-shortening.md) |
...
| [name-shortening.md](name-shortening.md) | Export-time channel/zone name shortening ([#130](https://github.com/pskillen/codeplug-tool/issues/130)) |
| [name-shortening-progress.md](name-shortening-progress.md) | Execution log for #130 |
