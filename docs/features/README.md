...
| Operator distance | `src/lib/geoDistance.ts`, `src/state/operatorPosition.tsx` | [operator-distance/](operator-distance/) | In progress ([#70](https://github.com/pskillen/codeplug-tool/issues/70)) |
